...
static const Rule rules[] = {
        ...
        { NULL, NULL, "eGroupWare [Kalender - Hinzufügen] - Mozilla Firefox", 0, 1, 0, 0, -1 },
...
#define STACKKEYS(MOD, ACTION)                                                                                                             \
        { MOD, XK_j, ACTION##stack, { .i = INC(+1) } }, { MOD, XK_k, ACTION##stack, { .i = INC(-1) } },                                    \
            { MOD, XK_grave, ACTION##stack, { .i = PREVSEL } }, { MOD, XK_q, ACTION##stack, { .i = 0 } },                                  \
            { MOD, XK_a, ACTION##stack, { .i = 1 } }, { MOD, XK_z, ACTION##stack, { .i = 2 } }, { MOD, XK_x, ACTION##stack, { .i = -1 } },
...
static const char *dmenucmd[]      = { "dmenu_run", "-m",  dmenumon, "-fn", dmenufont, "-nb", black, "-nf",
                                       gray3,       "-sb", yellow,   "-sf", black,     "-c",  NULL };
...
static const Key keys[] = {
        ...
        TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6)
            TAGKEYS(XK_8, 7) TAGKEYS(XK_9, 8){ MODKEY | ControlMask, XK_q, quit, { 0 } },
